...
colnames(crusio1[88])<-"weightDichotomy"
for(i in 1:923){ifelse(crusio1$bw[i] > median(crusio1$bw, na.rm = TRUE), crusio1$weightDichotomy[i] <- 1, crusio1$weightDichotomy[i] <- 0)}
```
